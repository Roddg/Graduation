...
public class DishTestData {
    ...
    public static final int DISH_1_ID = AbstractBaseEntity.START_SEQ + 13;
    public static final int DISH_2_ID = AbstractBaseEntity.START_SEQ + 14;
    public static final int DISH_3_ID = AbstractBaseEntity.START_SEQ + 15;
